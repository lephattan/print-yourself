<template>
  <div class="label-radio">
    ...
    <div class="flex gap-2 flex-wrap">
      ...
      >
        <div 
          class="border border-solid border-slate-400 hover:border-orange-400 rounded box-border p-1"
          :class="{'border-orange-500 border-2':value==option.value}"
          >
          <img :src="encodeURI(option.image)" :alt="option.value" class="m-auto w-[50px]">
        </div>
